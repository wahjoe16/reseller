    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ route('products-reseller.store') }}" method="post" enctype="multipart/form-data">@csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="numeric" name="price">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-flex px-2 py-1">
                                                <img src="{{ url('/img/' . $model->photo) }}" alt="" class="avatar avatar-lg">
                                            </div>
                                        </div>
                                    </div>
                                    @endif
